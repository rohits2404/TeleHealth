import { insertPatientPrescription } from '../../../Database/Doctor/Patient Prescription/Add.js';
...
const addPatientPrescription = async (req, res) => {
    ...
    try {
        const prescription = await insertPatientPrescription(doctorId, appointmentId, medicationDataList);
        if (!prescription) {
